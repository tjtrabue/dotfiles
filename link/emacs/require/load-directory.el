;;; load-directory.el --- Load all Elisp files in a directory -*- lexical-binding: t -*-
...
;;; Commentary:
;; This package provides the function `load-directory' to load all .el or .elc
...
(defvar load-directory-pre-load-file-hooks nil
  "Functions to be called on each filename loaded by load-directory, just
before loading that file.")
...
(defun find-subdirectory-from-path (subdir)
  "Return a full pathname for SUBDIR as a subdirectory of something on
load-path."
