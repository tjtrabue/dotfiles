...
#+begin_src emacs-lisp :tangle yes
  ...
  (setq gc-cons-threshold 200000000) ;; 200MiB

  ;; Increase the amount of data Emacs reads per unit time from a given process.
  ;; The initial value is 4KB, far too low for modern day applications.
