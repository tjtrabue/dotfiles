...
** Common Lisp
#+begin_src emacs-lisp
  ;; This is the path variable that ASDF reads when determining which directories hold Common Lisp
  ;; systems. Paths ending in a double-slash designate a directory tree to scan recursively for
  ;; systems.
  (setenv "CL_SOURCE_REGISTRY" (concat ".:./qlot/dists//:"
                                       (getenv "HOME")
                                       "/common-lisp//:"))
#+end_src
