...
#+begin_src emacs-lisp
  (let ((has-ugrep (executable-find "ugrep"))
    ...
    (grep-apply-setting 'grep-find-command
                        (cond (has-ugrep
                               `(,(concat "ugrep -e '' --color=always --index --no-heading -HI0inr"
    ...
    (grep-apply-setting 'grep-find-template
                        (cond (has-ugrep
                               (concat
                                "find -H <D> <X> -type f <F>"
                                " -exec ugrep <C> --index --no-heading -0HIPine <R> \\{\\} + ';'"))
                              (has-rg
                               (concat
                                "find -H <D> <X> -type f <F>"
                                " -exec rg --no-heading -0HPne <R> \\{\\} + ';'"))
                              (t
                               (concat "find -H <D> <X> -type f <F>"
                                       " -exec grep <C> -nH --null -e <R> \\{\\} + ';'")))))
#+end_src
