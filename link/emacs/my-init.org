...
#+begin_src emacs-lisp
  ...
  (use-package my-font
    ...
    :custom-face
    (default ((nil (:family "Fira Code" :height 110 :weight regular :width normal))))
    ...
    (italic ((nil (:family "VictorMono Nerd Font"
...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'minibuffer-prompt nil
                      :family (if-let* ((font (seq-find (lambda (f) (string= f "VictorMono Nerd Font"))
                                                        (font-family-list))))
                                  font
                                "Monospace")
                      :weight 'bold
