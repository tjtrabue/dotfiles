  ...
  #+begin_src emacs-lisp
    ...
    with straight.el.")
      ...
      (defvar my/lisp-major-modes
        '(clojure-mode emacs-lisp-mode ielm-mode lisp-mode sly-mrepl-mode)
...
* Load External Configuration Files
  ...
  #+begin_src emacs-lisp
    (my/apply-to-dir-files my/emacs-plugin-dir #'load-file "\\.el$")
    (my/apply-to-dir-files my/plugin-notebook-dir #'org-babel-load-file "\\.org$")
  #+end_src
