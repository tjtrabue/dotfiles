...
#+begin_src emacs-lisp :tangle yes
  (use-package spaceline-all-the-icons
    ...
    (setq spaceline-all-the-icons-separator-type 'wave
          ...
          ;; Enlarge the spaceline separators to account for the bigger modeline.
          ;; Otherwise, the separators do not align with the height of the
          ;; modeline properly.  Hopefully we can decrease this factor once a true
          ;; fix emerges.
          spaceline-all-the-icons-separator-scale 2.5
          powerline-text-scale-factor 1.00)
    :config
