...
#+begin_src emacs-lisp
  (use-package web-mode
    ...
    (with-eval-after-load "highlight-indent-guides"
      ;; Turn on highlight-indent-guides-mode specially for web-mode since having
      ;; web-mode inherit the hook from prog-mode makes the highlight guides look
      ;; ugly.  Adding this hook seems to fix the problem.
