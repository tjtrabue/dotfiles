...
#+begin_src emacs-lisp
  (use-package lsp-mode
    ...
    (general-def lsp-mode-map
      ;; We have to take the remap strategy to override evil's motion state
      ;; commands beginning with "g". Otherwise, evil's default keybindings take
      ;; precedence.
      ;; ga
      [remap what-cursor-position] 'lsp-code-actions-at-point
      ;; gd
      [remap evil-goto-definition] 'lsp-find-definition
      ;; go
      [remap evil-goto-char] 'lsp-organize-imports
      ;; gi
      [remap evil-insert-resume] 'lsp-find-implementation)
