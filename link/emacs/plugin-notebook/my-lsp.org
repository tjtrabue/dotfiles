...
#+begin_src emacs-lisp
  ...
  _a_:   abort   _k_: prev line        _<return>_: jump        _i_: prev branch
  _C-g_: abort   _J_: next file line   _j_:        jump back   _o_: next node
  ^ ^            _K_: prev file line   ^ ^                     _p_: prev node
  "
      ("P"        lsp-bridge-peek)
      ("a"        lsp-bridge-peek-abort :exit t)
...
#+begin_src emacs-lisp
  (use-package lsp-bridge
    ...
    (my/user-leader-def lsp-bridge-mode-map
      "lwa"  'lsp-bridge-code-action
      "lwd"  'lsp-bridge-find-def
      "lwod" 'lsp-bridge-find-def-other-window
      "lwgl" 'lsp-bridge-diagnostic-list
      "lwgc" 'lsp-bridge-diagnostic-copy
      "lwh"  'lsp-bridge-signature-help-fetch
      "lwi"  'lsp-bridge-find-impl
      "lwk"  'lsp-bridge-popup-documentation
      "lwp"  'hydra-lsp-bridge-peek/lsp-bridge-peek
      "lwR"  'lsp-bridge-find-references
      "lwr"  'lsp-bridge-rename
      "lws"  'lsp-bridge-restart-process
      "lwt"  'lsp-bridge-find-type-def
      "lww"  'lsp-bridge-workspace-list-symbols)
    ;; Keys for `lsp-bridge-mode''s autocomplete popup:
    (general-def acm-mode-map
      "C-j" 'acm-select-next
      "C-k" 'acm-select-prev
      "C-l" 'acm-complete)
    ;; Evil leader commands (each begins with ",w"):
    ...
    (acm-frame-background-light-color "#f2f2f2")
    (acm-frame-background-dark-color "#1e1e1e")
