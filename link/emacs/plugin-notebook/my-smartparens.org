...
* =use-package= specification
  ...
  #+begin_src emacs-lisp
    (use-package smartparens
      ;; A bit computationally intensive, and `electric-pair-mode' plus `lispy' does
      ;; nearly everything this plugin can do.
      :disabled
      :delight
      (smartparens-mode)
      (smartparens-strict-mode)
      ...
      ;; NOTE: `electric-pair-mode' does a perfectly good job of balancing delimiters for most
