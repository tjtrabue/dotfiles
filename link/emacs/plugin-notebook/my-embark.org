...
* =use-package= specification
  #+begin_src emacs-lisp
    (use-package embark
      ...
      ;; How you wish to display the embark-collect view:
      ;; 'list - List view (One row that wraps around if necessary)
      ;; 'grid - Grid view (Multiple columns)
      ...
      ;; Take out some commands from the list of commands that require the user to
      ;; edit and approve the command before embark acts. This makes these
      ;; particular commands a bit more snappy.
      (delete 'kill-buffer embark-allow-edit-commands))
  #+end_src
