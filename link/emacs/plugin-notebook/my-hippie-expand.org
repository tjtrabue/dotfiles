...
=dabbrev-expand=), expanding entire lines of text, or expanding in ways defined by
your own functions. Which of these it tries and in what order is controlled by a
...
#+begin_src emacs-lisp
  (use-package hippie-exp
    ...
    :general
    (general-def 'global
      ;; This remaps `M-/' from dynamic abbrev (which is pretty useless) to the much superior
      ;; `hippie-expand'.
