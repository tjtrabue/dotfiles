    ...
    (mapc (lambda (mode)
            (let ((mode-map (intern (concat (symbol-name mode) "-map"))))
              ...
              (my/evil-leader-def :keymaps mode-map
                ...
                "lW" 'my/lispyville-wrap-braces-and-insert
                "lb" 'my/lispyville-wrap-brackets-and-insert
                "lc" 'lispy-clone
  ...
  (defun my/set-lispyville-mode-keys ()
    ...
    (let ((mode-map 'lispyville-mode-map))
      (general-define-key
       ...
       "F" 'lispy-ace-paren
       ;; Move ARG sexps to an open paren determined by ace-paren.
       "T" 'lispy-teleport
      ...
      (general-define-key
       ...
       "{" 'lispy-braces
       "}" 'lispy-right-nostring
       "DEL" 'lispyville-delete-char-or-splice-backwards
