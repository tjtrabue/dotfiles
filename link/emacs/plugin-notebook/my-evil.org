  ...
  #+begin_src emacs-lisp :tangle yes
    (use-package evil
      ...
      (:map evil-normal-state-map
            ...
            ("<tab>" . tab-to-tab-stop)
            ;; Make pressing enter/return automatically insert comment markers
            ;; when creating a new line after a commented line.
   ...
   #+begin_src emacs-lisp :tangle yes
     (use-package lispyville
       ...
       (:map evil-collection-lispy-mode-map
             ...
             ("<normal-state> <" . nil)
             ("<normal-state> >" . nil)
             ;; We want "(" and ")" to navigate lists.
             ("<normal-state> (" . lispy-backward)
             ("<normal-state> )" . lispy-forward))
       :config
       (advice-add 'lispyville-yank :around 'my/highlight-evil-region-advice)
       (evil-define-key 'normal evil-collection-lispy-mode-map
         (kbd "M-m") 'lispy-mark-symbol)
       (evil-define-key '(insert visual) evil-collection-lispy-mode-map
         (kbd "M-;") 'lispy-comment)
