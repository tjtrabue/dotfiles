    ...
    #+begin_src emacs-lisp
      ...
      (defun my/set-lispyville-mode-keys ()
        ...
        (let ((keymap lispyville-mode-map))
          ...
          (general-def '(normal insert) keymap
            ;; Function navigation
            "M-h" 'lispyville-beginning-of-defun
            "M-l" 'lispyville-end-of-defun)
          (general-def '(normal visual) keymap
            ...
            ;; Mark symbol or list.
            "gm" 'lispy-mark-symbol
            "gM" 'lispy-mark)
          (general-def 'visual keymap
            "gc" 'lispyville-comment-or-uncomment-line
            "gC" 'lispyville-comment-or-uncomment
            "gy" 'lispyville-comment-and-clone-dwim)
          (general-def '(normal insert visual) keymap
            "M-;" 'lispy-comment)))
