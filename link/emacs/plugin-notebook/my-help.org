...
#+begin_src emacs-lisp
  (use-package helpful
    ;; NOTE 2/17/2022
    ;; elisp-refs, a dependency of this plugin, still depends on
    ;; read-symbol-positions-list, a deprecated Emacs variable in 29.0.50 and
    ;; onward.  This may cause problems, so please be aware.
