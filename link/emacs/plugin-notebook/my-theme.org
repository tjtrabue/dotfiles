...
#+begin_src emacs-lisp
  (defun my/modus-themes-custom-faces ()
    ...
    (modus-themes-with-colors
      ...
      (custom-set-faces
       ...
       ;; Set Org src block faces
       `(org-meta-line ((,c :foreground ,cyan-cooler)))
       `(org-block-begin-line ((,c :foreground ,cyan-cooler :weight bold)))
       `(org-block-end-line ((,c :foreground ,cyan-cooler :weight bold))))
  ...
  (defun my/activate-theme--modus ()
    ...
    (if (eq my/color-theme 'dark)
        ;; Load the dark Modus theme if we desire to dwell in darkness.
        (load-theme 'modus-vivendi t)
      ;; Otherwise, join the light side and be bright and happy.
