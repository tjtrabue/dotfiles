  ...
  (defun my/modus-themes-custom-faces ()
    ...
    (modus-themes-with-colors
      ...
      (with-eval-after-load "highlight-indent-guides"
        ...
        (set-face-background 'highlight-indent-guides-top-odd-face cyan-faint)
        (set-face-background 'highlight-indent-guides-top-even-face cyan-faint)
        (set-face-foreground 'highlight-indent-guides-top-character-face cyan-faint)
