  ...
  (defun my/modus-themes-custom-faces ()
    ...
    (modus-themes-with-colors
      ...
      (with-eval-after-load "highlight-indent-guides"
        ...
        (set-face-background 'highlight-indent-guides-top-odd-face bg-lavender)
        (set-face-background 'highlight-indent-guides-top-even-face bg-lavender)
        (set-face-foreground 'highlight-indent-guides-top-character-face bg-lavender)
        (set-face-background 'highlight-indent-guides-stack-odd-face bg-dim)
        (set-face-background 'highlight-indent-guides-stack-even-face bg-dim)
        (set-face-foreground 'highlight-indent-guides-stack-character-face bg-dim))))
#+end_src
