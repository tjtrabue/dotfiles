...
#+begin_src emacs-lisp
  (use-package elisp-autofmt
    ...
    ;; NOTE: `elisp-autofmt-mode' adds a function to `before-save-hook' that
    ;; messes with `aggressive-indent-mode'. Thus, I don't recommend you turn on
    ;; `elisp-autofmt-mode' unless you're not using `aggressive-indent-mode'.
