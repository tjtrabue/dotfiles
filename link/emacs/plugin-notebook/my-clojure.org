...
** Variables
   #+begin_src emacs-lisp
     (defvar my/extra-cider-jack-in-deps '(("zprint/zprint" "1.2.3"))
...
** =use-package= specification
  #+begin_src emacs-lisp
    (use-package cider
      ...
      ;; These variables must be set in :config instead of :custom due to a
      ;; loading order issue.
      ...
      (setq cider-jack-in-cljs-dependencies
            (delq nil
                  (delete-dups
                   (append cider-jack-in-cljs-dependencies
                           my/extra-cider-jack-in-deps)))))
  #+end_src
