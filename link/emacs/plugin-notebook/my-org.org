...
link with a title of a page found by the URL into the current buffer. It's a
little limited, but it's handy for getting URLs into an Org document, which you
can edit later.
