...
** org-roam
   ...
   Because =org-roam='s nodes are simple Org files, you can check your
   =org-roam= database into your favorite version control system. [[https://github.com/tjtrabue/roam-notes][I keep mine in
   GitHub]].
   ...
   #+begin_src emacs-lisp
     (use-package org-roam
       ...
       (setq org-roam-directory
             (file-truename (concat user-emacs-directory "roam-notes")))
