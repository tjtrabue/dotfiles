...
#+begin_src emacs-lisp
  (use-package org-modern
    ;; I am not certain, but I believe this plugin causes Emacs to lock up if window focus is lost
    ;; then regained. org-modern makes Org buffers look nice, but this plugin is unnecessary for
    ;; anything important.
    ;; :disabled
    :after org
    :custom
    ;; Do not use `org-indent-mode' as it interferes with org-modern's block prettification.
