...
#+begin_src emacs-lisp
  (use-package dired-subtree
    :after (dired-hacks evil-collection)
    :general
...
#+begin_src emacs-lisp
  (use-package dired-rainbow
    ;; NOTE 4/1/25: broken on the current version of Emacs. Waiting for a patch.
    :disabled
    :after dired-hacks
    :config
    (progn
...
#+begin_src emacs-lisp
  (use-package dired-ranger
    ;; I like to use dired the way it was intended. Ranger is for casuals.
    :disabled
    :after dired-hacks
    :general
