...
#+begin_src emacs-lisp
  (use-package ctrlf
    ;; I find that evil-mode's basic `evil-ex-search-forward' and `evil-ex-search-backward' work just
    ;; fine for my needs.
    :disabled
    :after evil-collection
    :demand t
    :general
    (general-def ctrlf-mode-map
      ;; Remap standard Emacs isearch keybinding
      "C-s" 'ctrlf-forward-default)
    (general-def 'normal ctrlf-mode-map
      ;; Remap standard Emacs isearch keybinding
      "C-s" 'ctrlf-forward-default
