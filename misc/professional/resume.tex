...
\personalinfo{
	...
	\github{https://github.com/tjtrabue}
...
\begin{itemize}
	...
	\item[--] \small{Developed an automated framework for detecting informal
			settlements.}
	\item[--] \small{The framework was computationally and cost efficient.}
	\item[--] \small{ Had never been accomplished with low-resolution imagery
			before.}
	\item[--] \small{We only had 8 weeks to find the data and come up with a
			solution.}
	\item[--] \small{Code is open-sourced
			\textbf{\href{https://github.com/FrontierDevelopmentLab/informal-settlements}{here}}
			and there is a blog post
			\textbf{\href{https://news.developer.nvidia.com/ai-helps-map-the-worlds-informal-settlements/?fbclid=IwAR3fXXlWQxP-QK6LYJICFm0DWrD1pBfRXOWZtA0lZ-vm1Tz_PjCs8cKdid4}{here}}.}
\end{itemize}
